...
module VAST
  ...
  #
  # === Sequence
  # The Creative element takes an optional "sequence" attribute that indicates
  # the suggested order in which the Creatives should be displayed. If two
  # Creative elements are intended to be shown at the same time they should
  ...
  class Creative < Element
    ...
    # Returns a hash, keyed by event name, containing an array of URIs to be
