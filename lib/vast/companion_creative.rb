...
module VAST
  # Commonly text, display ads, rich media, or skins that wrap around the video
  # experience. These ads come in a number of sizes and shapes and typically
  # run alongside or surrounding the video player.
  class CompanionCreative < Creative
    ...
    # Alternate text to be displayed when companion is rendered in HTML
    # environment.
    def alt_text
